...
import ProductDetails from '../../components/ProductDetails/ProductDetailsProps'
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  <Typography variant="subtitle2">
                    {t.page.product_id.specifications}
                    :
                  </Typography>
                  <Grid container>
                    <Grid item xs={12}>
                      <Box className={styles.productDetailsWrapper}>
                        <ProductDetails
                          group={
                            ...
                            || (selectedProduct.group && selectedProduct.group[0]?.name)
                          }
                          brand={
                            selectedProduct.brand?.name
                            || (selectedProduct.brand && selectedProduct.brand[0]?.name)
                          }
                ...
                <Grid item xs={12}>
                  <ConsignmentStatus product={selectedProduct} />
                </Grid>
              </Grid>
            </Grid>
